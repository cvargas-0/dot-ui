...
Web Components design system built with Vanilla TypeScript, CSS custom properties, and Vite.
...
│   ├── setup-agent.sh              # copies AGENT.md to AI agent files
│   └── skills/
│       ├── create-component/
...
├── CLAUDE.md                       # generated by setup-agent.sh
├── vite.config.ts
├── tsconfig.json
├── eslint.config.ts
└── .prettierrc
