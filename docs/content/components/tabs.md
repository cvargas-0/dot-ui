+++
title = "Tabs"
description = "Tabbed interface with keyboard navigation and ARIA support."
+++
...
<div class="doc-section">
  ...
  <ul>
    ...
    <li>Set <code>hidden</code> on inactive panels in HTML — the component manages state from there.</li>
  </ul>
</div>
